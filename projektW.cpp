		...
		case '1':
				...
				switch(klawisz2)
				{
					case '1':
							system("cls");
							ile=0;
							cout<<"Ile zwierz¹t chcesz kupiæ chcesz kupiæ"<<endl;
							cin>>ile;
							cout<<"Podaj nazwe zwierzêcia"<<endl;
							cin>>nazwa;
							cout<<"Podaj rase zwierzêcia"<<endl;
							cin>>rasa;
							cout<<"Podaj plec [XY/ XX] zwierzêcia"<<endl;
							cin>>plec;
							cout<<"Podaj wiek [mies.] zwierzêcia"<<endl;
							cin>>wiek;
							cout<<"Podaj masa [kg] zwierzêcia"<<endl;
							cin>>masa;
		...
		case '2':
				...
				switch(klawisz3)
				{
						case '1':
								...
								cin>>nazwa;
								ile=0;
								cout<<"Ile maszyn samojezdnych chcesz kupiæ"<<endl;
								cin>>ile;
						...
						case '2':
								system("cls");							
								cout<<"podaj nazwe maszyny samojezdnej która chcesz sprzedac"<<endl;
								cin>>nazwa;
								cout<<"podaj marke maszyny samojezdnej która chcesz sprzedac"<<endl;
								cin>>marka;
								cout<<"podaj model maszyny samojezdnej która chcesz sprzedac"<<endl;
								cin>>rasa;
						...
						case '3':
								system("cls");							
								cout<<"podaj nazwe maszyny samojezdnej która chcesz naprawic"<<endl;
								cin>>nazwa;
								cout<<"podaj marke maszyny samojezdnej która chcesz naprawic"<<endl;
								cin>>marka;
								cout<<"podaj model maszyny samojezdnej która chcesz naprawic"<<endl;
								cin>>rasa;
								for(size_t i=0; i<garaz.size(); ++i)
								{
									maszyna_s* szt=garaz.at(i);
		...
		case '3':
				...
				switch(klawisz4)
				{
						case '1':
								system("cls");
								ile=0;
								cout<<"Ile maszyn chcesz kupiæ"<<endl;
								cin>>ile;
						...
						case '2':
								system("cls");							
								cout<<"podaj nazwe maszyny która chcesz sprzedac"<<endl;
								cin>>nazwa;
								cout<<"podaj marke maszyny która chcesz sprzedac"<<endl;
								cin>>marka;
								cout<<"podaj model maszyny która chcesz sprzedac"<<endl;
								cin>>rasa;
						...
						case '3':
								system("cls");							
								cout<<"podaj nazwe maszyny która chcesz naprawic"<<endl;
								cin>>nazwa;
								cout<<"podaj marke maszyny która chcesz naprawic"<<endl;
								cin>>marka;
								cout<<"podaj model maszyny która chcesz naprawic"<<endl;
								cin>>rasa;
								for(size_t i=0; i<wiata.size(); ++i)
								{
									maszyna_z* szt=wiata.at(i);
		...
		case '4':
				...
				switch(klawisz5)
				{
					case '1':
							...
							cout<<"Ile hektarow na jednej dzialce chcesz kupiæ"<<endl;
					...
					case '3':
							system("cls");							
							cout<<"podaj nr dzia³ki na ktorej chcesz pracowaæ"<<endl;
							cin>>masa;
							for(size_t i=0; i<grunt.size(); ++i)
							{
								ziemia* szt=grunt.at(i);
									...
									do
									{
										...
										switch(klawisz6)
										{
											case '1':
													...
													{
														system("cls");	
														cout<<"Podaj nazwe maszyny którym chcesz orac"<<endl;
														cin>>nazwa;
														cout<<"Podaj marke maszyny którym chcesz orac"<<endl;
														cin>>marka;
														cout<<"Podaj model maszyny którym chcesz orac"<<endl;
														cin>>marka;
														for(size_t i=0; i<garaz.size(); ++i)
														{
														...
														cout<<"podaj marke p³uga którym chcesz orac"<<endl;
														cin>>nazwa;
														for(size_t i=0; i<wiata.size(); ++i)
														{
											...
											case '2':
													...
													{
														system("cls");	
														cout<<"Podaj nazwe maszyny którym chcesz uprawiaæ"<<endl;
														cin>>nazwa;
														cout<<"Podaj marke maszyny którym chcesz uprawiaæ"<<endl;
														cin>>marka;
														cout<<"Podaj model maszyny którym chcesz uprawiaæ"<<endl;
														cin>>marka;
														for(size_t i=0; i<garaz.size(); ++i)
														{
															maszyna_s* szt1=garaz.at(i);
														...
														cout<<"podaj marke agreagtu którym chcesz uprawiaæ"<<endl;
														cin>>nazwa;
														for(size_t i=0; i<wiata.size(); ++i)
														{
															maszyna_z* szt2=wiata.at(i);
											...
											case '3':
													...
													{
														system("cls");	
														cout<<"Podaj nazwe maszyny którym chcesz siac"<<endl;
														cin>>nazwa;
														cout<<"Podaj marke maszyny którym chcesz siac"<<endl;
														cin>>marka;
														cout<<"Podaj model maszyny którym chcesz siac"<<endl;
														cin>>marka;
														for(size_t i=0; i<garaz.size(); ++i)
														{
															maszyna_s* szt1=garaz.at(i);
														...
														cout<<"podaj marke siewnika którym chcesz siac"<<endl;
														cin>>nazwa;
														for(size_t i=0; i<wiata.size(); ++i)
														{
															maszyna_z* szt2=wiata.at(i);
											...
											case '4':
													...
													{
														system("cls");	
														cout<<"Podaj nazwe maszyny którym chcesz rozsiewac"<<endl;
														cin>>nazwa;
														cout<<"Podaj marke maszyny którym chcesz rozsiewac"<<endl;
														cin>>marka;
														cout<<"Podaj model maszyny którym chcesz rozsiewac"<<endl;
														cin>>marka;
														for(size_t i=0; i<garaz.size(); ++i)
														{
															maszyna_s* szt1=garaz.at(i);
														...
														cout<<"podaj marke rozsiewacza którym chcesz rozsiewac nawoz"<<endl;
														cin>>nazwa;
														for(size_t i=0; i<wiata.size(); ++i)
														{
															maszyna_z* szt2=wiata.at(i);
											...
											case '5':
													...
													{
														system("cls");	
														cout<<"Podaj nazwe maszyny którym chcesz pryskac"<<endl;
														cin>>nazwa;
														cout<<"Podaj marke maszyny którym chcesz pryskac"<<endl;
														cin>>marka;
														cout<<"Podaj model maszyny którym chcesz pryskac"<<endl;
														cin>>marka;
														for(size_t i=0; i<garaz.size(); ++i)
														{
															maszyna_s* szt1=garaz.at(i);
														...
														cout<<"podaj marke opryskiwacza którym chcesz pryskac"<<endl;
														cin>>nazwa;
														for(size_t i=0; i<wiata.size(); ++i)
														{
															maszyna_z* szt2=wiata.at(i);
											...
											case '6':
													...
													{
														system("cls");	
														cout<<"Podaj nazwe maszyny którym chcesz zbirac plon"<<endl;
														cin>>nazwa;
														cout<<"Podaj marke maszyny którym chcesz zbirac plon"<<endl;
														cin>>marka;
														cout<<"Podaj model maszyny którym chcesz zbirac plon"<<endl;
														cin>>marka;
														for(size_t i=0; i<garaz.size(); ++i)
														{
															maszyna_s* szt1=garaz.at(i);
